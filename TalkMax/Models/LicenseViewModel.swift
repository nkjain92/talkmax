...
class LicenseViewModel: ObservableObject {
    ...
    private func loadLicenseState() {
        ...
        if let licenseKey = userDefaults.licenseKey {
            ...
            if userDefaults.activationId != nil || !userDefaults.bool(forKey: "TalkMaxLicenseRequiresActivation") {
        ...
        let hasLaunchedBefore = userDefaults.bool(forKey: "TalkMaxHasLaunchedBefore")
        if !hasLaunchedBefore {
            // First launch - start trial automatically
            userDefaults.set(true, forKey: "TalkMaxHasLaunchedBefore")
            startTrial()
            return
        }
    ...
    func validateLicense() async {
        ...
        do {
            ...
            if licenseCheck.requiresActivation {
                ...
                userDefaults.set(true, forKey: "TalkMaxLicenseRequiresActivation")
                self.activationsLimit = limit
                
            } else {
                // This license doesn't require activation (unlimited devices)
                userDefaults.activationId = nil
                userDefaults.set(false, forKey: "TalkMaxLicenseRequiresActivation")
    ...
    func removeLicense() {
        ...
        userDefaults.set(false, forKey: "TalkMaxHasLaunchedBefore")  // Allow trial to restart
...
extension UserDefaults {
    var activationId: String? {
        get { string(forKey: "TalkMaxActivationId") }
        set { set(newValue, forKey: "TalkMaxActivationId") }
    }
}
