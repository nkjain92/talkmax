...
struct AboutView: View {
    ...
    private var appLogo: some View {
        ...
        .accessibilityLabel("TalkMax App Icon")
    }
    ...
    private var appDescription: some View {
        VStack(spacing: 10) {
            ...
            Text("TalkMax is a powerful voice-to-text application that leverages local whisper AI models to provide accurate and efficient transcription in real-time.")
                .font(.body)
    ...
    private var featuresSection: some View {
        VStack(alignment: .leading, spacing: 15) {
            ...
            FeatureRow(icon: "chart.bar", text: "TalkMax insights and metrics")
    ...
    private var contactInfo: some View {
        VStack(spacing: 15) {
            ...
            Button(action: {
                if let url = URL(string: "mailto:nishank@gmail.com?subject=TalkMax%20Help%20%26%20Support") {
                    NSWorkspace.shared.open(url)
                }
            }) {
                Text("nishank@gmail.com")
                    .underline()
                    .foregroundColor(.blue)
            }
            .buttonStyle(PlainButtonStyle())
            
            Text("© 2025 TalkMax. All rights reserved.")
                .font(.caption)
                .foregroundColor(.secondary)
        }
        .padding()
