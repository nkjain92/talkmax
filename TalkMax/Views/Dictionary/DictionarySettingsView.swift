...
struct DictionarySettingsView: View {
    ...
    enum DictionarySection: String, CaseIterable {
        ...
        var description: String {
            switch self {
            case .spellings:
                return "Train TalkMax to recognize industry terms, names, and technical words"
            case .replacements:
    ...
    private var heroSection: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Enhance TalkMax's transcription accuracy by teaching it your vocabulary")
                    .font(.system(size: 15))
