        ...
        VStack(spacing: 24) {
            ...
            VStack(spacing: 16) {
                HStack(spacing: 16) {
                    ...
                    Text(licenseViewModel.licenseState == .licensed ? "TalkMax Pro" : "Upgrade to Pro")
                        .font(.system(size: 32, weight: .bold))
                }
                
                Text(licenseViewModel.licenseState == .licensed ? 
                     "Thank you for supporting TalkMax" :
                ...
                if case .licensed = licenseViewModel.licenseState {
                    HStack(spacing: 40) {
                        Button {
                            if let url = URL(string: "https://github.com/Beingpax/TalkMax/releases") {
                        ...
                        Button {
                            if let url = URL(string: "mailto:nishank@gmail.com") {
                                NSWorkspace.shared.open(url)
                            }
                        } label: {
                        ...
                        Button {
                            if let url = URL(string: "https://github.com/Beingpax/TalkMax/issues") {
                                NSWorkspace.shared.open(url)
                            }
                        } label: {
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                if licenseViewModel.activationsLimit > 0 {
                    ...
                    Text("You can use TalkMax Pro on all your personal devices")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
            }
