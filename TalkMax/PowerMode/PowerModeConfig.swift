...
struct PowerModeConfig: Codable, Identifiable, Equatable {
    ...
    // MARK: - Migration Support (can be removed in future versions)
    private enum CodingKeys: String, CodingKey {
        case id, name, emoji, appConfigs, urlConfigs, isAIEnhancementEnabled
        case selectedPrompt, selectedTranscriptionModel, selectedLanguage
        case useScreenCapture, selectedAIProvider, selectedAIModel
    ...
    init(from decoder: Decoder) throws {
        ...
        useScreenCapture = try container.decodeIfPresent(Bool.self, forKey: .useScreenCapture) ?? false
        selectedAIProvider = try container.decodeIfPresent(String.self, forKey: .selectedAIProvider)
        selectedAIModel = try container.decodeIfPresent(String.self, forKey: .selectedAIModel)
        
        // Migration: prefer new field, fallback to old field, then nil
        selectedTranscriptionModel = try container.decodeIfPresent(String.self, forKey: .selectedTranscriptionModel) 
                                   ?? container.decodeIfPresent(String.self, forKey: .selectedWhisperModel)
    }
    // MARK: - End Migration Support
    
    init(id: UUID = UUID(), name: String, emoji: String, appConfigs: [AppConfig]? = nil, 
         urlConfigs: [URLConfig]? = nil, isAIEnhancementEnabled: Bool, selectedPrompt: String? = nil,
         selectedTranscriptionModel: String? = nil, selectedLanguage: String? = nil, useScreenCapture: Bool = false,
        ...
        self.selectedTranscriptionModel = selectedTranscriptionModel ?? UserDefaults.standard.string(forKey: "CurrentTranscriptionModel")
        ...
        if let data = UserDefaults.standard.data(forKey: defaultConfigKey),
           let config = try? JSONDecoder().decode(PowerModeConfig.self, from: data) {
            ...
            defaultConfig = PowerModeConfig(
                ...
                selectedPrompt: nil,
                selectedTranscriptionModel: defaultModelName,
