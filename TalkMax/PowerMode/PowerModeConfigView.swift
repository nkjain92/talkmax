...
struct ConfigurationView: View {
    ...
    init(mode: ConfigurationMode, powerModeManager: PowerModeManager) {
        ...
        case .edit(let config):
            ...
            _selectedTranscriptionModelName = State(initialValue: latestConfig.selectedTranscriptionModel)
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        // Transcription Model Selection Subsection
                        if whisperState.usableModels.isEmpty {
                            ...
                            // Create a simple binding that uses current transcription model if nil
    ...
    private func getConfigForForm() -> PowerModeConfig {
        ...
        case .add:
                ...
                urlConfigs: websiteConfigs.isEmpty ? nil : websiteConfigs,
                    ...
                    selectedTranscriptionModel: selectedTranscriptionModelName,
        ...
        case .edit(let config):
            ...
            updatedConfig.selectedTranscriptionModel = selectedTranscriptionModelName
